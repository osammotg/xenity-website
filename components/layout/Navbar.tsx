...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#F7F6F7]/90 backdrop-blur-md border-b border-[rgba(27,12,37,0.06)] shadow-[0_1px_12px_rgba(27,12,37,0.04)]" : ""}`}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex items-center justify-between h-[72px]">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2 font-semibold text-[#1B0C25] text-sm">
            <Image src="/images/logo.png" width={28} height={28} alt="Xinity AI" className="rounded-md" />
